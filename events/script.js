...
const eventDetails = [
  ...
  },
  {
    ...
    modalDescription:
      "Get ready to weave the digital canvas with WEBBED! This solo event challenges participants to craft a stunning stand-alone webpage using HTML, CSS, and vanilla JavaScript. Unleash your creativity with the same set of images provided to all, bringing your design to life!<br><br>Rules:<ul><li>Team Size: One to Two</li><li>Create a stand-alone webpage (front end only) using HTML, CSS, and vanilla JavaScript, incorporating the same set of provided images.</li></ul>",
